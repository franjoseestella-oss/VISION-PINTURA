...
namespace BaslerCameraStreamParams_Params
{
    ...
    {
        AccessMode_Control,  //!< Applies to: acA1920-48gm
        AccessMode_Exclusive,  //!< Applies to: acA1920-48gm
        AccessMode_Monitor,  //!< Applies to: acA1920-48gm
        AccessMode_NotInitialized  //!< Applies to: acA1920-48gm
    };

    //! Valid values for Status
    enum StatusEnums
    {
        Status_Closed,  //!< The stream grabber is closed - Applies to: acA1920-48gm
        Status_Locked,  //!< The stream grabber is locked - Applies to: acA1920-48gm
        Status_NotInitialized,  //!< The stream grabber is not initialized - Applies to: acA1920-48gm
        Status_Open  //!< The stream grabber is open - Applies to: acA1920-48gm
    };

    //! Valid values for TransmissionType
    enum TransmissionTypeEnums
    {
        TransmissionType_LimitedBroadcast,  //!< The stream data is sent to all devices in the local area network (255 255 255 255) - Applies to: acA1920-48gm
        TransmissionType_Multicast,  //!< The stream data is sent to selected devices in the local network   - Applies to: acA1920-48gm
        TransmissionType_SubnetDirectedBroadcast,  //!< The stream data is sent to all devices in the same subnet as the camera - Applies to: acA1920-48gm
        TransmissionType_Unicast,  //!< The stream data is sent to a single device in the local network - Applies to: acA1920-48gm
        TransmissionType_UseCameraConfig  //!< The stream transmission configuration is read from the camera - Applies to: acA1920-48gm
    };

    //! Valid values for Type
    enum TypeEnums
    {
        Type_SocketDriver,  //!< The socket driver is used - Applies to: acA1920-48gm
        Type_WindowsFilterDriver  //!< The pylon GigE Vision Filter Driver is used - Applies to: acA1920-48gm
    };
    ...
    */
    ...
    //@{
    /*!
        \brief Indicates the mode of access the current application has to the device - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Enables negotiation of the packet size to find the largest possible packet size - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief IP address to which the stream grabber sends all stream data - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Port to which the stream grabber sends all stream data - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Enables the packet resend mechanism - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Firewall traversal interval value in milliseconds  This applies to the stream channel  If set to 0, this feature is disabled - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Maximum time in milliseconds to receive all packets of a frame - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Maximum size (in bytes) of a buffer used for grabbing images - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Maximum number of buffers that can be used simultaneously for grabbing images - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Maximum number of resend requests per missing packet - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Timeout period in milliseconds between two packets within one frame - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Determines the largest possible packet size - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Thread priority of the receive thread - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Enables assigning a custom priority to the thread which receives incoming stream packets - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Size (in frames) of the receive window in which the stream grabber looks for missing packets - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Amount of packet resend requests to be batched, i e , sent together - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Time to wait (in milliseconds) between sending a resend request and considering the request as lost - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Threshold after which resend requests are initiated - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Time to wait (in milliseconds) between detecting a missing packet and sending a resend request - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Socket buffer size in kilobytes - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Number of frames lost because there were no buffers in the queue - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief GigE cameras: Number of buffers with at least one failed packet  A packet is considered failed if its status is not 'success'  Other cameras: Number of buffers that returned with an error status   - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Number of failed packets - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Number of packets requested by packet resend commands - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Number of emitted packet resend commands sent - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief GigE cameras: Number of frames received  Other cameras: Number of buffers processed - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Number of packets received - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Indicates the current status of the stream grabber - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Sets how stream data is transferred within the network - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Sets the driver type to be used by the stream grabber - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Indicates whether the GigE Accelerator is currently available - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Indicates whether the socket driver is currently available - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Indicates whether the pylon GigE Vision Filter Driver is currently available - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Indicates whether the pylon GigE Vision Performance Driver is currently available - Applies to: acA1920-48gm
    ...
    */
    ...
    //@{
    /*!
        \brief Use Extended ID if available in the camera and supported by the driver - Applies to: acA1920-48gm
